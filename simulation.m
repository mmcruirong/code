...
cfgHT.MCS = 4;                   % 2 spatial streams, 64-QAM rate-5/6
...
%rx = tgnChannel(tx);
mixed_waveform = waveform_zigbee + 2*[waveform_wifi;zeros(33300-4895,1)];
...
[rxPSDU,eqSYM,ofdmDemodData,qamDemodOut,scramInit,deintlvrOut,streamDeparserOut,qamDemodOut_hard] = wlanHTDataRecover_local(htdata,chanEst,nVarHT,cfgHT);
...
WiFi_only_reconstruct = 2*[waveform_wifi_reconstruct;zeros(33300-4895,1)] - waveform_zigbee_reconstruct;  
